class_name ContentA1
extends Control

#memanggil label dari list pertanyaan
@onready var label_pertanyaan :RichTextLabel = $HBoxContainer/VBoxContainer/Panel/MarginContainer/VBoxContainer/Pertanyaan
...
@onready var objcontainer = $HBoxContainer/VBoxContainer/Panel/MarginContainer/VBoxContainer/HBoxContainer2/Control/object_container2
@onready var objcontainer2 = $HBoxContainer/VBoxContainer/Panel/MarginContainer/VBoxContainer/HBoxContainer2/Control2/object_container2
...
#	level_timer.start(0.1)
	...
	textures.shuffle()
	var texture_buah = get_texture()
	objcontainer.buah = texture_buah
	objcontainer2.buah = texture_buah
	
		
#	objcontainer.set_max_columns(3)
#	objcontainer2.set_max_columns(3)
...
func set_objects(texture ,num_object1: int): #,object_type:String
	self.num_object = num_object1
	print("Setting objects 1 to: ", num_object)
	objcontainer.setMaxObjects(num_object)
	objcontainer.buah = texture
#	objcontainer.updateObject(num_object) #, object_type

func set_objects2(texture, num_object2: int): #,object_type:String
	self.num_object = num_object2
	print("Setting objects 2 to: ", num_object)
	objcontainer2.setMaxObjects(num_object)
	objcontainer2.buah = texture
...
func button_benar():
	...
	objcontainer2.set_random_fruit()
	print("Jawaban Benar")
	time_left = total_time
	progressbar.value = total_time
