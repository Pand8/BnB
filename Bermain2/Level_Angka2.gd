...
@onready var konten : ContentA1 = $CanvasLayer/Content2
...
var question_sets: Array = ListPertanyaan.pertanyaan_angka2.duplicate()
...
func _ready():
	...
	Global.load_game_angka2()
	Global.set_game_type(Score.Tipe.ANGKA2)
...
func set_konten(isi_konten):
	...
	var texture_buah = konten.get_texture()
	konten.set_objects(texture_buah, isi_konten.num_object1)
	konten.set_objects2(texture_buah, isi_konten.num_object2)
	
	print("objects1:", isi_konten.num_object1)
	print("objects2:", isi_konten.num_object2)
...
func game_over():
	get_tree().change_scene_to_file("res://Result/result_angka2.tscn")
